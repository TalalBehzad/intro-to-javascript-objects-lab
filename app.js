...
*/
const starter = pokemon.find(p => p.Name === "Pikachu");
...
game.party = [
    ...
    console.log("current game.party contents:", game.party);
...
game.gymStatus = function(){
    const gymTally = { completed: 0, incomplete:
   0 };
   for(let i = 0; i < game.gyms.length; i++){
